...
class restore_forcotutors_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('MIROTRANSLATEVIEWBYID', '/mod/forcotutors/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('MIROTRANSLATEINDEX', '/mod/forcotutors/index.php?id=$1', 'course');
